...
function [fitting] = dispersion_fitting(dispersion,T,a)
...
Tlung = lsqcurvefit(flung, Tlguess, T(1:id), dispersion(1:id));
...
beta = lsqcurvefit(frich,bguess, T(2:id), dispersion(2:id));
%disp(frich(beta, T(2))) 
...
kappa = lsqcurvefit(fdiff, Kguess, T(1:id), dispersion(1:id));
