...
% run plot_rel_disp_all.m before this
...
for k =1:2:6
   ...
   m(i)  = shadedErrorBar_semilogy(T+0.001, Obsdisp_mean(:,1,k), Obsdisp_cilog(:,:,1,k), ...
...
hold all 
   ...
   %                'o-','linewidth',3,'color',colors(i*2,:));
                ...
                hold all
    g(i) = semilogy(T, Moddisp(:,1,k), '--', 'color', colors(i*2,:), 'linewidth', 3);
    
    i=i+1
end
%A = legend([h(1),h(2), h(3), g], ...
%    {'Obs 10-15km', 'Obs 30-35km', 'Obs 50-55km','Mod 11km', 'Mod 33km', 'Mod 50km'}) ;
A = legend([m(1).mainLine,m(2).mainLine, m(3).mainLine, g], ...
    {'Obs 10-15km', 'Obs 30-35km', 'Obs 50-55km','Mod 11km', 'Mod 33km', 'Mod 50km'}) ;
...
for k =1:2:6
    ...
    h(i)= shadedErrorBar_semilogy(T+0.001, Obsdisp_mean(:,2,k), Obsdisp_cilog(:,:,2,k), ...
                    {'-','linewidth',3,'color',colors(i*2,:)},1)
   %  h(i)= semilogy(T, Obsdisp_mean(:,2,k), ...
   %                'o-','linewidth',3,'color',colors(i*2,:));
   
                hold all
    g(i) = semilogy(T, Moddisp(:,2,k), '--', 'color', colors(i*2,:), 'linewidth', 3);
...
for k =1:2:6
    ...
    h(i)= loglog(T, Obsdisp_mean(:,1,k) - Obsdisp_mean(1,1,k), ...
                    'o-','linewidth',3,'color',colors(i*2,:))
                hold all
    g(i) = loglog(T, Moddisp(:,1,k) - Moddisp(1,1,k), '--', 'color', colors(i*2,:), 'linewidth', 3)
...
for k =1:2:6
    ...
    h(i)= loglog(T, Obsdisp_mean(:,2,k) - Obsdisp_mean(1,2,k), ...
                    'o-','linewidth',3,'color',colors(i*2,:));
                hold all
    g(i) = loglog(T, Moddisp(:,2,k) - Moddisp(1,2,k), '--', 'color', colors(i*2,:), 'linewidth', 3);
...
for k =1:2:6
    ...
    h(i)= semilogx(T, (Obsdisp_mean(:,1,k) - Obsdisp_mean(1,1,k))./T'.^2, ...
                    'o-','linewidth',3,'color',colors(i*2,:));
                hold all
    g(i) = semilogx(T, (Moddisp(:,1,k) - Moddisp(1,1,k))./T'.^2, '--', 'color', colors(i*2,:), 'linewidth', 3);
...
for k =1:2:6
    ...
    h(i)= semilogx(T, (Obsdisp_mean(:,2,k) - Obsdisp_mean(1,2,k))./T'.^2, ...
                    'o-','linewidth',3,'color',colors(i*2,:));
                hold all
    g(i) = semilogx(T, (Moddisp(:,2,k) - Moddisp(1,2,k))./T'.^2, '--', 'color', colors(i*2,:), 'linewidth', 3);
...
for k =1:2:6
    ...
    h(i)= loglog(T, Obsdisp_mean(:,1,k).^(1/3) - Obsdisp_mean(1,1,k).^(1/3), ...
                    'o-','linewidth',3,'color',colors(i*2,:));
                hold all
    g(i) = loglog(T, Moddisp(:,1,k).^(1/3) - Moddisp(1,1,k).^(1/3), '--', 'color', colors(i*2,:), 'linewidth', 3);
...
for k =1:2:6
    ...
    h(i)= loglog(T, Obsdisp_mean(:,2,k).^(1/3) - Obsdisp_mean(1,2,k).^(1/3), ...
                    'o-','linewidth',3,'color',colors(i*2,:));
                hold all
    g(i) = loglog(T, Moddisp(:,2,k).^(1/3) - Moddisp(1,2,k).^(1/3), '--', 'color', colors(i*2,:), 'linewidth', 3);
...
for k =1:2:6
    ...
    h(i)= semilogx(T, (Obsdisp_mean(:,depth,k).^(1/3) - Obsdisp_mean(1,depth,k).^(1/3))./T', ...
                    'o-','linewidth',3,'color',colors(i*2,:));
                hold all
    g(i) = semilogx(T, (Moddisp(:,depth,k).^(1/3) - Moddisp(1,depth,k).^(1/3))./T', '--', 'color', colors(i*2,:), 'linewidth', 3);
